...
mysql -u root -p${MYSQL_ROOT_PASSWORD} --execute \
"GRANT ALTER,CREATE,DELETE,DROP,INDEX,INSERT, REFERENCES, SELECT,UPDATE,TRIGGER,ALTER ROUTINE, CREATE ROUTINE, EXECUTE, CREATE TEMPORARY TABLES ON $PRISMA_DATABASE.* TO '$PRISMA_USER_PROD'@'%';"
